...
Only requiring some minor changes is stargate.cpp.
...
Changes to stargate.cpp
----------------------
stargate.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
