...
This mechanism has been integrated into Bitcore-Node-stargate which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stargatepay/insight-api-stargate#web-socket-api](https://github.com/stargatepay/insight-api-stargate#web-socket-api)
* API: [https://github.com/stargatepay/insight-api-stargate#instantsend-transactions](https://github.com/stargatepay/insight-api-stargate#instantsend-transactions)
...
By default, the stargate Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the stargate Core daemon:
