...
stargate Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as stargate Core, where everyone uses
...
pay attention to for reviewers of stargate Core code.

General stargate Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: stargate Core uses tinyformat, which is type safe. Leave them out to avoid confusion
