...
#define BOOST_TEST_MODULE stargate Test Suite

#include "test_stargate.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_stargate_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
