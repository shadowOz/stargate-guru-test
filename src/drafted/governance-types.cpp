...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "stargateNetwork") type = stargateNetwork;
    if(strType == "stargateNetworkVariable") type = stargateNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == stargateNetwork) s = "stargateNetwork";
    if(type == stargateNetworkVariable) s = "stargateNetworkVariable";
