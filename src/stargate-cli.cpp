...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("stargate Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  stargate-cli [options] <command> [params]  " + _("Send command to stargate Core") + "\n" +
                  "  stargate-cli [options] help                " + _("List commands") + "\n" +
                  "  stargate-cli [options] help <command>      " + _("Get help for a command") + "\n";
