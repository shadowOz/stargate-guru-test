...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case STG: return QString("stargate");
            case mSTG: return QString("Milli-stargate (1 / 1" THIN_SP_UTF8 "000)");
            case uSTG: return QString("Micro-stargate (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-stargate (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case STG: return QString("Teststargates");
            case mSTG: return QString("Milli-Teststargate (1 / 1" THIN_SP_UTF8 "000)");
            case uSTG: return QString("Micro-Teststargate (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Teststargate (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
