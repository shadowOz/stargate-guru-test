    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("stargate Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About stargate Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stargate-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the stargate in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 STG, 0.1 STG, 1 STG and 10 STG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://stargatepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://stargatepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("stargate Core is shutting down...") + "<br /><br />" +
