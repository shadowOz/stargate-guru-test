    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STG-light"), QVariant("light"));
    ui->theme->addItem(QString("STG-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("STG-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STG-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STG-traditional"), QVariant("trad"));
