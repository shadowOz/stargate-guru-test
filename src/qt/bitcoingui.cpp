    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("stargate Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a stargate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stargate: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About stargate Core"), this);
    aboutAction->setStatusTip(tr("Show information about stargate Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for stargate Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your stargate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified stargate addresses"));
    ...
    openAction->setStatusTip(tr("Open a stargate: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the stargate Core help message to get a list with possible stargate Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("stargate Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to stargate network", "", count));
    } else {
...
{
    QString strTitle = tr("stargate Core"); // default title
